...
$args['menu_title'] = __('Great', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Great', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo using the Upload Button or insert image URL.', 'nhp-opts')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
					...
					array(
						...
						'sub_desc' => __('Enter your FeedBurner\'s URL here.)', 'nhp-opts'),
						'std' => '#'
						),
					array(
						...
						'sub_desc' => __('Enter your Facebook profile or page link here.', 'nhp-opts'),
						'std' => '#'
						),
					array(
						'id' => 'mts_google_plus',
						'type' => 'text',
						'title' => __('Google Plus Link', 'nhp-opts'),
						'sub_desc' => __('Enter your G+ profile link here.', 'nhp-opts'),
						'std' => '#'
						),
					array(
						'id' => 'mts_linked',
						...
						'sub_desc' => __('Enter your LinkedIn profile link here.', 'nhp-opts'),
						'std' => '#'
						),
					array(
						'id' => 'mts_pinterest_username',
						'type' => 'text',
						'title' => __('Pinterest Profile', 'nhp-opts'),
						'sub_desc' => __('Enter Pinterest Profile link here.', 'nhp-opts'),
						'std' => '#'
						),
					array(
						'id' => 'mts_header_code',

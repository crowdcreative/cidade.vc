...
global $post;
	...
	echo '<form action="" enctype="multipart/form-data" id="primaryPostForm" method="POST">';
		...
		echo '<div class="bloco"><h2 style="padding-bottom: 8px; border-bottom: 1px solid rgb(221, 221, 221);">Serviços oferecidos</h2></div>';
	...
	?>
		...
		$contatos = get_post_meta($post->ID, 'contatos', true); // pega valor do BD

...
global $post;
	...
	echo '<div class="bloco"><h2 style="padding-bottom: 8px; border-bottom: 1px solid rgb(221, 221, 221);">Criar lugar na categoria: saúde</h2></div>';

	echo '<form action="" enctype="multipart/form-data" id="primaryPostForm" method="POST">';
		...
		echo '<div class="bloco"><div class="row">';
		    ...
		    $args = array('child_of' => 64, 'hide_empty' => 0);
	    ...
	    # H2 -> Atividades e Eventos

		echo '<div class="bloco"><h2 style="padding-bottom: 8px; border-bottom: 1px solid rgb(221, 221, 221);">Atividades e Eventos</h2></div>';
		...
		$atividades_possiveis = get_post_meta($post->ID, 'atividades_possiveis', true); // pega valor do BD
		...
		echo '<div class="bloco"><h2 style="padding-bottom: 8px; border-bottom: 1px solid rgb(221, 221, 221);">Como ter acesso</h2></div>';
	...
	?>
		...
		echo '<div class="bloco"><h2 style="padding-bottom: 8px; border-bottom: 1px solid rgb(221, 221, 221);">Contato</h2></div>';
	    ...
	    echo '<div class="bloco"><div class="row">'; 
	    	echo '<div class="col-sm-3"><label class="pull-right" for="telefone">Foto que representa o lugar</label></div>';
		        echo '<div class="col-sm-9">';
		        	echo '<img src="'.$atachment_url[0].'" width="200px">';
